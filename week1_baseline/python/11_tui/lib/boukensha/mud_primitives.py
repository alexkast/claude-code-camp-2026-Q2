...
belong to the Agent/tool layer that wraps these primitives as tool calls.

This is an original Python reimplementation of the Ruby `mud_manager` gem's
`MudManager::Primitives` module (vendored at
week0_explore/mud_manager/lib/mud_manager/primitives.rb), not a wrapper
...
INFO_WORLD = (
    "who", "users", "help", "credits", "news", "info", "motd",
    "policies", "version", "wizlist", "immlist", "clear", "whoami",
)
...
def _cmd(primitive: str, verb: str, raw: str, **args: Any) -> Command:
