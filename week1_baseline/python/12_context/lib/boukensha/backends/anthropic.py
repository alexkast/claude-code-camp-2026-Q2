...
class Anthropic(Base):
    ...
    MODELS: dict[str, dict[str, Any]] = {
        ...
        # supports adaptive thinking and the effort flag; non-adaptive
        # thinking is deprecated for sonnet.
        "claude-sonnet-4-6": {
        ...
        # supports adaptive thinking and the effort flag; non-adaptive
        # thinking is deprecated for opus.
        "claude-opus-4-8": {
            "context_window": 1_000_000,
    ...
    def _assistant_content(self, content: Any) -> Any:
